  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await actions.sendData(
        ...
        _model.medInfo!.whenToTake.first.toString(),
      );
      await actions.sendData(
        BTDeviceStruct(
          name: widget.deviceName,
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<MedicationsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final pedestalPageMedicationsRecord = snapshot.data!;
                        ...
                        children: [
                              ...
                              Flexible(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      16.0, 8.0, 16.0, 8.0),
                                  child: AutoSizeText(
                                    'To finish setting up your medication, swipe through the steps below:',
                                    textAlign: TextAlign.start,
                                    style:
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                              child: Text(
                                                'Step 2: Zero out the pedestal by (insert what action is needed to zero out the pedestal).',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                              child: Text(
                                                'Step 3: Place a single pill on the pedestal.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                              child: Text(
                                                'Step 4: Wait for confirmation from both the pedestal and the phone application that the weight has been recorded.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                              ),
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Flexible(
                                              child: Text(
                                                'Step 5: When set up is complete, press the button below to continue.',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium,
                                              ),
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: _model.receivedData != 'complete'
                                  ? null
                                  : () async {
                                      context.pushNamed(
                                        'MedicationPage',

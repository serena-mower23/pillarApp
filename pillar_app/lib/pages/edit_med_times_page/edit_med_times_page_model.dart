...
import 'edit_med_times_page_widget.dart' show EditMedTimesPageWidget;
...
class EditMedTimesPageModel extends FlutterFlowModel<EditMedTimesPageWidget> {
  ...
  // Stores action output result for [Custom Action - getMedicationInfo] action in EditMedTimesPage widget.
  ...
  bool? switchValue;
  // Stores action output result for [Custom Action - editMedications] action in Button widget.
  List<MedInfoStruct>? editedMeds;

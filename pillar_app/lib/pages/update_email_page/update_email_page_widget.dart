...
class UpdateEmailPageWidget extends StatefulWidget {
  const UpdateEmailPageWidget({Key? key}) : super(key: key);

  @override
  _UpdateEmailPageWidgetState createState() => _UpdateEmailPageWidgetState();
}
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Please input your new email below. ',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      'Note: You will be brought back to the login page.',
